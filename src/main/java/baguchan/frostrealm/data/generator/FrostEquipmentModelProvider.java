...
public class FrostEquipmentModelProvider implements DataProvider {
    private final PackOutput.PathProvider pathProvider;

    public FrostEquipmentModelProvider(PackOutput p_371200_) {
    ...
    public CompletableFuture<?> run(CachedOutput p_371294_) {
        ...
        FrostEquipmentModels.bootstrap((p_371303_, p_371237_) -> {
